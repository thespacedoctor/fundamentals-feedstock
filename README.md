...
Once the `conda-forge` channel has been enabled, `fundamentals` can be installed with:

```
conda install fundamentals
```

It is possible to list all of the versions of `fundamentals` available on your platform with:
